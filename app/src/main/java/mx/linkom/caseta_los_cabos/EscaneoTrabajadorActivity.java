...
public class EscaneoTrabajadorActivity extends mx.linkom.caseta_los_cabos.Menu {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("error")){
                    Conf.setST("Denegado");
                    Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_los_cabos.BitacoraTrabajadorActivity.class);
                    startActivity(i);
                    finish();
                }else {
    ...
    public void onBackPressed(){
        super.onBackPressed();
        Intent intent = new Intent(getApplicationContext(), mx.linkom.caseta_los_cabos.ReportesActivity.class);
