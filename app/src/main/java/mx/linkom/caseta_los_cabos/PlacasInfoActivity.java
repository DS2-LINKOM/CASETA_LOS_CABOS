...
public class PlacasInfoActivity extends mx.linkom.caseta_los_cabos.Menu{
    ...
    public void Usuario(final String IdUsu){
        ...
        String url = "https://communitycabo.sist.com.mx/plataforma/casetaV2/controlador/LOS_CABOS/placas_3.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void dtlLugar(final String idUsuario){
        String url = "https://communitycabo.sist.com.mx/plataforma/casetaV2/controlador/LOS_CABOS/placas_4.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
