...
public class AccesosMultiplesActivity extends mx.linkom.caseta_los_cabos.Menu {
    Configuracion Conf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("ATCIVITY", "AccesosMultiplesActivity");
...
//ALETORIO3
    ...
    public void salidas(final String id_visitante) {
        String URLResidencial = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/CC/vst_php4_2.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLResidencial, new Response.Listener<String>() {
