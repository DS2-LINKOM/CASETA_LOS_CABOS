package mx.linkom.caseta_los_cabos.offline.Servicios;
                        ...
                        while (true) {
                            ...
                            try {
                                if (internet){
                                    ...
                                    new Ping(testInternet.this).execute();
                                }else {
    ...
    public void enviarCorrespondenciasActualizadas(Context context){
        ...
        try{
            ...
            if (actualizarCorrespondencia.moveToFirst()){
                new Correspondencias_actualizadas_sync(actualizarCorrespondencia).execute();
            }else {
    ...
    public void enviarCorrespondencia(Context context){
        ...
        try{
            ...
            if (insertICorrespondencia.moveToFirst()){
                ...
                new Correspondencias_insertadas_sync(insertICorrespondencia).execute();
            }else{
                ...
                if (eliminar >= 0){
                    try {
                        ...
                        for (int i = 0; i<array.length(); i++){
                            ...
                            values.put("foto4", object.getInt("foto4"));
                            values.put("nombre_foto4", object.getString("nombre_foto4"));
                            values.put("estatus", object.getInt("estatus"));
                            values.put("sqliteEstatus", 0);
