...
public class AccesosSalidasActivity extends mx.linkom.caseta_los_cabos.Menu {
    Configuracion Conf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("ACTIVITY", "AccesosSalidasActivity");
    ...
    public void RegistrarH (){
        String URL = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/CC/vst_reg_7.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
