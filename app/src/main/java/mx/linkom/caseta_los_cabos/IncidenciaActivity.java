...
public class IncidenciaActivity  extends mx.linkom.caseta_los_cabos.Menu{
        ...
        alertDialogBuilder
                ...
                .setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        dialog.cancel();
                        botonPresionado(1);
                        /*Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_linkaccess.ReportesActivity.class);
                        startActivity(i);
                        finish();*/
                    }
    ...
    public void Registrar(final int Id){
        ...
        String URL = "https://communitycabo.sist.com.mx/plataforma/casetaV2/controlador/LOS_CABOS/incidencias.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response){
                ...
                if(response.equals("error")){
                    ...
                    if (Global_info.getCantidadFotosEnEsperaEnSegundoPlano(IncidenciaActivity.this) >= Global_info.getLimiteFotosSegundoPlano()){
                        if(Id==2){
                            upload1();
                            terminar();
                        }else if(Id==3){
    ...
    private void terminar() {
        ...
        if (Global_info.getCantidadFotosEnEsperaEnSegundoPlano(IncidenciaActivity.this) > 0){
            if (!servicioFotos()){
