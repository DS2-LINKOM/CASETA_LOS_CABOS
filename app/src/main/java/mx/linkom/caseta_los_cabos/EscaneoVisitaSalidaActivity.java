...
public class EscaneoVisitaSalidaActivity extends mx.linkom.caseta_los_cabos.Menu {
        ...
        if((pl+sl).equals("AR")){
            ...
            try {
                ...
                if (cursor.moveToFirst()){
                    ...
                    Conf.setST("Aceptado");
                    Log.e("EscaneoVisitaSalida", "AccesosAutosSalidasActivity");
                    Intent i = new Intent(getApplicationContext(), AccesosAutosSalidasActivity.class);
                    startActivity(i);
                    finish();

                }else {
                    Conf.setST("Denegado");
                    Log.e("EscaneoVisitaSalida", "AccesosAutosSalidasActivity1");
                    Intent i = new Intent(getApplicationContext(), AccesosAutosSalidasActivity.class);
                    startActivity(i);
                    finish();
                }
