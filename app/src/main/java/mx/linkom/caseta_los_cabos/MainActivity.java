...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mx.linkom.caseta_los_cabos.Global.TOKEN.equals("")) {
            mx.linkom.caseta_los_cabos.Global.TOKEN = FirebaseInstanceId.getInstance().getToken();
            Log.d(TAG, "Token Generado: " + mx.linkom.caseta_los_cabos.Global.TOKEN);
        }
    ...
    public void Nip() {
        if (Nip.toString().isEmpty()) {
            ...
            String URL = "https://communitycabo.sist.com.mx/plataforma/casetaV2/controlador/LOS_CABOS/pin.php";
    ...
    public void Residencial() {
        ...
        String URL = "https://communitycabo.sist.com.mx/plataforma/casetaV2/controlador/LOS_CABOS/residencial.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void Login() {
        if (User.toString().isEmpty()) {
            ...
            String URL = "https://communitycabo.sist.com.mx/plataforma/casetaV2/controlador/LOS_CABOS/session.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
            RequestQueue requestQueue = Volley.newRequestQueue(this);
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
...
//                            Conf.setRegTraba(ja3.getString(8));
                            ...
                            mx.linkom.caseta_los_cabos.Global.USER = ja3.getString(3);
                            mx.linkom.caseta_los_cabos.Global.PASS = ja3.getString(4);
                            mx.linkom.caseta_los_cabos.Global.EMAIL = ja3.getString(5);

                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                                CharSequence channelName = "COMMUNITY CABO";
                            ...
                            Intent i = new Intent(getApplication(), mx.linkom.caseta_los_cabos.DashboardActivity.class);
                            startActivity(i);
                            finish();
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("Token", mx.linkom.caseta_los_cabos.Global.TOKEN.trim());
    ...
    protected void onStart() {
        ...
        if (ActivityCompat.checkSelfPermission(MainActivity.this, permissions[0]) != PackageManager.PERMISSION_GRANTED) {
            ...
            if(fUser != null){
                Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_los_cabos.DashboardActivity.class);
                startActivity(i);
                finish();
