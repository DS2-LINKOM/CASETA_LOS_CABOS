...
public class AccesoRegistroActivity extends mx.linkom.caseta_los_cabos.Menu {
    Configuracion Conf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registrar5 = (LinearLayout) findViewById(R.id.registrar5);
    ...
    public void calles() {
        ...
        String URL = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/CC/vst_reg_1.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
    ...
    public void imagenes() {
        try {
            ...
            if (ja3.getString(9).trim().equals("1")) {
                ...
                nombre_fotoPlaca.setText(ja3.getString(10) + ":");
            ...
            if (ja3.getString(0).equals("0") || ja3.getString(3).equals("0")) {
                ...
                Foto1.setVisibility(GONE);
                espacio2.setVisibility(GONE);
                Foto1View.setVisibility(GONE);
                espacio3.setVisibility(GONE);
                registrar2.setVisibility(GONE);
                espacio4.setVisibility(GONE);
                Foto2.setVisibility(GONE);
                espacio5.setVisibility(GONE);
                Foto2View.setVisibility(GONE);
                espacio6.setVisibility(GONE);
                registrar3.setVisibility(GONE);
                espacio7.setVisibility(GONE);
                Foto3.setVisibility(GONE);
                espacio8.setVisibility(GONE);
                Foto3View.setVisibility(GONE);
                espacio9.setVisibility(GONE);
                registrar4.setVisibility(GONE);
                espacio10.setVisibility(GONE);


            } else if (ja3.getString(3).equals("1")) {

                registrar1.setVisibility(GONE);
                espacio1.setVisibility(GONE);


                if (ja3.getString(9).trim().equals("0")) {
                    Foto1.setVisibility(View.VISIBLE);
                    espacio2.setVisibility(View.VISIBLE);
                    nombre_foto1.setVisibility(View.VISIBLE);
    ...
    public void numeros(final String IdUsu) {
        ...
        String URL = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/CC/vst_reg_9.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
        ...
        try {
            ...
            Numero.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (Numero.getSelectedItem().equals("Seleccionar...")) {
                    } else {
                        busqueda();
                    }
    ...
    public void busqueda() {
        ...
        if (Calle.getSelectedItem().equals("Seleccionar..") || Calle.getSelectedItem().equals("Seleccionar...") || Numero.getSelectedItem().equals("Seleccionar...")) {
            ...
            String URL = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/CC/vst_reg_2.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
            RequestQueue requestQueue = Volley.newRequestQueue(this);
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
...
//                                    }).create().show();
    ...
    public void ext() {
        ...
        String URL = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/CC/vst_reg_10.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response.equals("error")) {
                    ...
                    alertDialogBuilder.setTitle("Alerta");
                    alertDialogBuilder
                            .setMessage("No tiene extensión asignada")
                            .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                    ...
                    try {
                        ...
                        registrar5.setVisibility(View.VISIBLE);

                        llamar.setText(ja5.getString(6));
                        llamar.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                try {
                                    number = Uri.parse("tel:" + ja5.getString(6));
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                }
    ...
    public void registro() throws JSONException {
        ...
        if (Placas.getText().toString().equals("") && si.isChecked()) {
            ...
            String URL = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/CC/vst_reg_3_2.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
            RequestQueue requestQueue = Volley.newRequestQueue(this);
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
