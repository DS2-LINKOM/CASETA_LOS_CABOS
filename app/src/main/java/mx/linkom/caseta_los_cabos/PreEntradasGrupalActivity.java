...
public class PreEntradasGrupalActivity extends mx.linkom.caseta_los_cabos.Menu {
    Configuracion Conf;
    ...
    LinearLayout Foto1, Foto2, Foto3, LinLayEspacioPlacasCono, LinLayPlacasTextoPorFoto, CPlacasTexto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iconoInternet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Offline) {
                    android.app.AlertDialog.Builder alertDialogBuilder = new android.app.AlertDialog.Builder(PreEntradasGrupalActivity.this);
        ...
        Log.e("ACTIVITY", "PreEntradasGrupalQr" + Global.getFotoPlaca() + " btn: " + btnFotoPlacaFuePresionado);
...
//ALETORIO3
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == 0) {
                ...
                /*if (Offline){
                    ...
                    bitmap = BitmapFactory.decodeFile(getApplicationContext().getExternalFilesDir(null) + "/accesosGrupal1.png");
                }*/
            ...
            if (requestCode == 1) {
                ...
                /*if (Offline){
                    ...
                    bitmap2 = BitmapFactory.decodeFile(getApplicationContext().getExternalFilesDir(null) + "/accesosGrupal2.png");
                }*/
            ...
            if (requestCode == 2) {
                ...
                /*if (Offline){
                    ...
                    bitmap3 = BitmapFactory.decodeFile(getApplicationContext().getExternalFilesDir(null) + "/accesosGrupal3.png");
                }*/
            ...
            if (requestCode == 3) {
                ...
                if (modeloCargado) {
                    String txtPlaca = DetectarPlaca.getTextFromImage(DetectarPlaca.reconocerPlaca(bitmap4, objectDetectorClass, 1), PreEntradasGrupalActivity.this);
    ...
    public void VisitaOffline() {
        Log.e("Metodo ", "visitaOffline");

        try {
            String id = Conf.getIdvisita();
            String id_res = Conf.getResid().trim();
            String parametros[] = {id, id_res};

            Cursor cursor = getContentResolver().query(UrisContentProvider.URI_CONTENIDO_VISITA, null, "vst_gru_2", parametros, null);
    ...
    public void Visita() {
        ...
        String URL = "https://communitycabo.sist.com.mx/plataforma/casetaV2/controlador/LOS_CABOS/vst_gru_2.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void dtlLugarOffline(final String idUsuario) {
        ...
        Log.e("Metodo ", "dtl lugar Offline");
    ...
    public void salidas(final String id_visitante) {
        String URLResidencial = "https://communitycabo.sist.com.mx/plataforma/casetaV2/controlador/LOS_CABOS/vst_php4.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLResidencial, new Response.Listener<String>() {
    ...
    public void Dtl_pre() {
        ...
        String URL = "https://communitycabo.sist.com.mx/plataforma/casetaV2/controlador/LOS_CABOS/vst_reg_8_2.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
        ...
        alertDialogBuilder
                ...
                .setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        /*Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_linkaccess.EntradasSalidasActivity.class);
                        startActivity(i);
                        finish();*/
    ...
    public void Registrar() throws JSONException {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    if (response.equals("error")) {
                        ...
                        if (Global_info.getCantidadFotosEnEsperaEnSegundoPlano(PreEntradasGrupalActivity.this) >= Global_info.getLimiteFotosSegundoPlano()){
                            if(fotos1==1){
                                upload1();
                            }
                            if(fotos2==1){
    ...
    public void Terminar() {
        ...
        if (Global_info.getCantidadFotosEnEsperaEnSegundoPlano(PreEntradasGrupalActivity.this) > 0){
            if (!servicioFotos()) {
                Intent cargarFotos = new Intent(PreEntradasGrupalActivity.this, subirFotos.class);
