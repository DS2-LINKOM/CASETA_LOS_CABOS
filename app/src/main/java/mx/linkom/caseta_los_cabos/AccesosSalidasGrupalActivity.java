...
public class AccesosSalidasGrupalActivity extends Menu {
    Configuracion Conf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("ACTIVITY", "AccesosSalidasGrupalActivity");
        ...
        txtFoto1 = (TextView) findViewById(R.id.txtFotoAccesosGrupalesSalidas1);
        txtFoto2 = (TextView) findViewById(R.id.txtFotoAccesosGrupalesSalidas2);
        txtFoto3 = (TextView) findViewById(R.id.txtFotoAccesosGrupalesSalidas3);
        ...
        iconoInternet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Offline){
                    android.app.AlertDialog.Builder alertDialogBuilder = new android.app.AlertDialog.Builder(AccesosSalidasGrupalActivity.this);
        ...
        try {
            ...
            if (cursor.moveToFirst()){
                try {
                    ...
                    ja1.put(cursor.getString(16));//Estatus de sqlite
    ...
    public void salidas (final String id_visitante){
        String URLResidencial = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/CC/vst_php6_2.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLResidencial, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
    ...
    public void Registrar (){
        ...
        String URL = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/CC/vst_php7_2.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
