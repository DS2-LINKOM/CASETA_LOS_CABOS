...
public class EscaneoTrabajadorSalidaActivity  extends mx.linkom.caseta_los_cabos.Menu{
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("error")){
                    Conf.setST("Denegado");
                    Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_los_cabos.AccesosTrabajadorSalidaActivity.class);
                    startActivity(i);
                    finish();
                }else {
