...
public class ListaGrupalSalidaActivity extends mx.linkom.caseta_los_cabos.Menu {
    ...
    public void invitados() {
        String URL = "https://communitycabo.sist.com.mx/plataforma/casetaV2/controlador/LOS_CABOS/vst_gru_3_2.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
