...
public class VisitasRecepSalidasDetalle extends mx.linkom.caseta_los_cabos.Menu {
    Configuracion Conf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtFoto1 = (TextView) findViewById(R.id.txtFotoVisitasRecepSalidasDetalle1);
        txtFoto2 = (TextView) findViewById(R.id.txtFotoVisitasRecepSalidasDetalle2);
        txtFoto3 = (TextView) findViewById(R.id.txtFotoVisitasRecepSalidasDetalle3);
    ...
    public void salidas (final String id_visitante){
        String URLResidencial = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/CC/vst_php6.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLResidencial, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
    ...
    public void dtl_recpecion (){
        String URL = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/CC/visitas_recep_4.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
    ...
    public void Registrar (){
        ...
        String URL = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/CC/visitas_recep_5.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
