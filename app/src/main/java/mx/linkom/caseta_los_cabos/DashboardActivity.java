...
import mx.linkom.caseta_los_cabos.Animaciones.AnimationUtil;
...
import mx.linkom.caseta_los_cabos.offline.Servicios.testInternet;

public class DashboardActivity extends  mx.linkom.caseta_los_cabos.Menu {
                ...
                if (response.length()>0){
                    try {
                        ...
                        if (!Global.getVersionApp().trim().equals(ja3.getString(16).trim())){
                            ...
                            textViewVersionDisponible.setText("Versión: Community Cabo " + ja3.getString(16));
                ...
                if (entrada != null) {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                                    if (position == 0 ){
                                        Intent docugen = new Intent(getApplication(), EntradasSalidasActivity.class);
