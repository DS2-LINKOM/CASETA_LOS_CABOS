...
public class  AccesosMorososActivity extends mx.linkom.caseta_los_cabos.Menu {
    ...
    public void Registrar (){
        ...
        String URL = "https://communitycabo.sist.com.mx/plataforma/casetaV2/controlador/LOS_CABOS/vst_php10.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
